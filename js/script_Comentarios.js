...
function commentBox(){
	...
	imagenPrevisualizacion01 = document.querySelector("#imagenPrevisualizacion01"),
	imagenPrevisualizacion02 = document.querySelector("#imagenPrevisualizacion02");
	...
	if(comment ==""){
       ...
       /* /////////////////////////////////////////////////////// */
		...
		el_icon01.setAttribute('id', 'Like_'+contador);
		...
		el_icon03.setAttribute('id', 'Dislike_'+contador);
		...
		el_icon02.setAttribute('id', 'starFavorite_'+contador);
		...
		if(!archivos || !archivos.length){		  
			el_imagen.src= imagenPrevisualizacion02.src;
			  ...
			  const url_imagen = URL.createObjectURL(primerArchivo);
			  el_imagen.src = url_imagen;
			}
